...
- [Week 13 — Mar 30](weeks/week-13-2026-03-30.md) — Feature engineering + Bike Sharing Feature Pipeline (stages 1–3 of 6; continues week 15)
...
- [Bike Sharing Feature Pipeline](builds/bike-sharing-feature-pipeline.md) — Staged feature engineering on the Bike Sharing Demand dataset; baseline → time-derived/cyclical features → categorical encoding, RMSLE-measured at each stage (in progress)
